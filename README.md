...
## Bonus Tasks
 ...
 Tasks completed, the page is now response, and after the 500px break point the page starts forming up accordingly with the biggest mobile phone's specs.

 The features can be tested by going into the Dev tools of chrome and change the mode to mobile version
